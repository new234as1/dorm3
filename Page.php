                    ...
                    <div id="stickyBlockStartPoint1" style="">
                        <div class="js-sticky-block border border-color-7 rounded mb-5 bg-white" data-parent="#stickyBlockStartPoint1" data-offset-target="#logoAndNav" data-sticky-view="lg" data-start-point="#stickyBlockStartPoint1" data-end-point="#stickyBlockEndPoint1" data-offset-top="30"
                            ...
                            <div class="p-4">
                                ...
                                <div class="text-center">
                                    <button type="button" class="btn btn-primary height-60 w-100 mb-xl-0 mb-lg-1 transition-3d-hover" data-toggle="modal" data-target="#exampleModal"><i class="flaticon-magnifying-glass mr-2"></i>จอง</button>
                                </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="save_insert.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">รหัสหอพักที่ต้องการจอง</label>
                                            <input class="form-control" type="text" name="id_dorm" id="id_dorm" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">รหัสห้องพักที่ต้องการจอง</label>
                                            <input class="form-control" type="text" name="id_room" id="id_room" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">หมายเลขห้องที่ต้องการจอง</label>
                                            <input class="form-control" type="text" name="room_number" id="room_number" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">ชื่อผู้จอง</label>
                                            <input class="form-control" type="text" name="fname_user" id="fname_user" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">นามสกุลผู้จอง</label>
                                            <input class="form-control" type="text" name="lname_user" id="lname_user" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">เบอร์โทรศัพท์</label>
                                            <input class="form-control" type="text" name="phone_user" id="phone_user" />
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary" name="button" id="button" value="Save" >Submit</button>
                                    </div>
                                    </form>
                                    </div>
                                </div>
                                ...
                                <br>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-Success height-60 w-100 mb-xl-0 mb-lg-1 transition-3d-hover" data-toggle="modal" data-target="#myModal" ><i class="fa fa-compress" aria-hidden="true"></i>&nbsp; เปรียบเทียบ</button>
