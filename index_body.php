<!---------------------- รายการพอพักเอกชน ------------------------>
<main id="dormitory" class="tabs-block tab-v1 " data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-3 mb-md-4 pb-1" ng-model="domebo" ng-repeat="x in dormSet track by $index" data-aos="zoom-in" data-aos-delay="300">
                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100 ">
                            ...
                            <a href="././Page.php?dormid={{x.id_dorm}}&idzone={{x.id_zone}} " class="d-block ">
                                ...
                                <a href="././Page.php?dormid={{x.id_dorm}}&idzone={{x.id_zone}} " class="card-title text-dark font-size-17 font-weight-bold ">{{x.address}}</a>
                                <div class="my-2 ">
